...
fig=figure('Color','w','Visible','off','Units','inches','Position',[1 1 3.45 6.8]);
...
plotPhysical(ax1,physical,"linear_features",0,colors.j0,'o-','quadrature, J=0');
plotPhysical(ax1,physical,"linear_features",.65,colors.j65,'s-','quadrature, J=0.65');
...
legend(ax1,'Location','southoutside','Orientation','horizontal', ...
    'NumColumns',2,'Box','off','FontSize',8.8); grid(ax1,'on'); box(ax1,'on');
...
legend(ax2,'Location','southoutside','Orientation','horizontal', ...
    'NumColumns',2,'Box','off','FontSize',8.8); grid(ax2,'on'); box(ax2,'on');
set([ax1 ax2],'FontName','Arial','FontSize',10.5,'LineWidth',.9);
