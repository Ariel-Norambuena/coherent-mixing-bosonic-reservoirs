...
xticks(ax2,1:2);xticklabels(ax2,{'nondegenerate','equal frequencies'});xtickangle(ax2,12);ylabel(ax2,'validation NRMSE');title(ax2,'(b) Deterministic spectral diversity','FontWeight','normal');legend(ax2,'Interpreter','latex','Location','northwest','Box','off');
