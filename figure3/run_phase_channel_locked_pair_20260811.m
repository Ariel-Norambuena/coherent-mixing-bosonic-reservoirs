%% One locked synthetic coherent phase-stream pair.
...
KERR_NARMA_CUSTOM_INPUT_RAW=uRaw;KERR_NARMA_CUSTOM_INPUT_ENCODED=uEncoded;KERR_NARMA_CUSTOM_TARGET=target;KERR_NARMA_TASK_LABEL='synthetic coherent phase-stream processing';KERR_NARMA_SKIP_PHYSICAL_ABLATIONS=true;KERR_NARMA_SKIP_BASELINES=true;KERR_NARMA_DISABLE_PLOTS=true;
