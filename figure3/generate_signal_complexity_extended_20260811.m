...
fig=figure('Color','w','Visible','off','Units','inches','Position',[1 1 7.4 6.75]);
...
plot(ax1,idx,y(idx),'Color',blue,'LineWidth',1.25,'DisplayName','$y_k$');xlabel(ax1,'symbol $k$','Interpreter','latex');ylabel(ax1,'amplitude');title(ax1,'(a) NARMA10 recurrence','FontWeight','normal');legend(ax1,'Interpreter','latex','Location','southoutside','Orientation','horizontal','NumColumns',2,'Box','off','FontSize',10.5);
